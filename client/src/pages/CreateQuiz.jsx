...
const CreateQuiz = () => {
    ...
    return (
        <>
            ...
            <Container>
                <Wrapper>
                    <TableContainer component={Paper} style={{backgroundColor: "#272727"}}>
                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                            <TableHead>
                                <TableRow style={{ backgroundColor: "#272727" }}>
                            ...
                            <TableBody>
                                {examDatas.map((exam, index) => (
                                    ...
                                    >
                                        <TableCell component="th" scope="exam" style={{ backgroundColor: "#272727",color: "#ffffff", fontSize: "16px", fontWeight: "600", padding: "25px" }}>
