    ...
    <>
      ...
      <Container>
        <Wrapper>
          ...
          <TableContainer component={Paper} style={{backgroundColor:"#333333"}}>
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead>
                <TableRow style={{ backgroundColor: "#333333"}}>
                  <TableCell style={{color: "#ffffff"}}>Quizzes</TableCell>
              ...
              <TableBody>
                {examNameStorage.map((name) => (
                  ...
                  >
                    <TableCell component="th" scope="row" style={{color: "#ffffff"}} onClick={() => { navigator.clipboard.writeText("http://localhost:3000/quiz/" + name._id) }}>
